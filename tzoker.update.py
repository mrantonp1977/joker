...
title_label = tk.Label(window, text="TZOKER Random Number Generator", font=("Arial black", 40),borderwidth=20,relief="ridge", bg="blue", fg="yellow")
title_label.pack(pady=25)

# Create a button to generate numbers
generate_button = tk.Button(window, text="Υπολογισμός Τυχαίων Αριθμών\nClick Here !!!", font=("Arial black", 19),bg="yellow",bd=20, fg="#DE15F0", command=generate_numbers)
...
for i in range(12):
    ...
    label_numbers = tk.Label(frame, text="Οι 5 τυχαίοι αριθμοί είναι:", font=("Arial black", 14), bg="#7FCBC4", fg="blue")
